...
public class NumberOfContactPerson {
    ...
    public static void addressBook(NumberOfContactPerson operations){
    ...
    public static void searchByCity(ArrayList<Contacts> contactDetails){
        ...
        System.out.println("Number of person present in the same city is:------------");
        System.out.println(contactDetails.stream().filter(contacts -> contacts.getCity().equalsIgnoreCase(input)).count());
    }
    public static void searchByState(ArrayList<Contacts> contactDetails){
        ...
        String input=scan.next();
        System.out.println("Number of person present in the same state is:------------");
        System.out.println(contactDetails.stream().filter(contacts -> contacts.getState().equalsIgnoreCase(input)).count());
    }
    ...
    public static void performances(NumberOfContactPerson operations, ArrayList<Contacts> contactDetails){
        int numberOfPerson;
        ...
        for(int i=0;i<numberOfPerson;i++){
            ...
            display(contactDetails);}
        int number;
        System.out.println("Please choose the Operation for Address book: 1)Input Details, 2)Edit Details, 3)Delete Details, 4)Search by City, 5)Search by State, 6)Display ");
    ...
    public static void main(String[] args) {
        ...
        NumberOfContactPerson operations=new NumberOfContactPerson();
