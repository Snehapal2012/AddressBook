...
public class ViewPersonByCityOrState {
    ...
    public static void addressBook(ViewPersonByCityOrState operations){
    ...
    public static void performances(ViewPersonByCityOrState operations, ArrayList<Contacts> contactDetails){
        int numberOfPerson;
    ...
    public static void main(String[] args) {
        ...
        ViewPersonByCityOrState operations=new ViewPersonByCityOrState();
